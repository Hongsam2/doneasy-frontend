                    ...
                    <div className="cmt_info ml-0 relative -top-2">
                        <div className="txt_cmt block relative mt-1 pt-3 pl-3 pr-3 pb-4 border-none rounded-lg text-[#444] text-base bg-[#f7f8f9] ">
                            ...
                            <textarea
                                ...
                                className="w-full h- resize-none outline-0 block relative mt-1 pt-3 pl-3 pr-3 pb-4 border-none rounded-lg text-[#444] text-base bg-[#f7f8f9]"
                                name="txtCmt"
                            ...
                            <button
                                ...
                                className="-w-9 absolute -bottom-10 right-0 w-88 h-8 rounded-sm text-base leading-8 text-[#fff] bg-[#828282] "
                            >
                                등록
                            </button>
                        </div>
