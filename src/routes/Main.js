            ...
            <div className=" w-11/12 mx-auto font-kakao">
                <div className="my-4">
                    ...
                    <div className="flex flex-col font-medium lg:flex-row lg:space-x-6 lg:mt-0 bg-white shadow-md mb-6 rounded-2xl w-3/4">
                        <div className='w-1/2'><img alt='' src='/img/give.jpg' className="rounded-l-2xl"></img>
                        </div>
                        <div className="px-4 py-10">
                        <p className="text-2xl font-bold mb-4">WELCOME TO DONEASY!</p>
                        <p className="text-gray-500">DONEASY는 당신의 소중한 참여를 기다립니다.</p>
                        <p className="text-gray-500">당신의 참여로 세상을 바꿀 수 있습니다.</p>
                        <p className="text-gray-500">지금 당장 시작하세요!</p>
                        </div>
                    </div>
                    <div className="font-bold bg-yellow-300 shadow-md mb-6 rounded-2xl w-1/4">
                        <div className="mx-8 my-8 ">
                        <div className="text-2xl">우리가</div>
                        <div className="text-2xl">같이만든 변화들</div>
                        <div className="mt-2 text-gray-500"><TodayFormal/>기준</div>
                    ...
                    <div className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-6 lg:mt-0 bg-white shadow-md mb-12 rounded-2xl w-3/4">
                        <div className='w-1/2'><img alt='' src='/img/hand.jpg' className="rounded-l-2xl"></img></div>
                        <div className="px-4 py-10">
                            <p className="text-2xl font-bold mb-4">DONEASY 기부 방법</p>
                            <p className="text-gray-500">직접 기부 : 후원금을 직접 결제합니다.</p>
                            <p className="text-gray-500">참여 기부 : 기부 프로그램에 응원과 댓글을 남겨주시면 </p>
                            <p className="text-gray-500">후원 기업의 지원금으로 각각 100원씩 기부됩니다.</p>
                        </div>
                    </div>
