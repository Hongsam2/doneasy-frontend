...
function ProjectDetail() {
    ...
    const onSupportClick = () => {
        ...
        axios
            .post('http://localhost:8080/support-of-project/save-support', {
            ...
            <div className="pt-0 mb-100">
                ...
                >
                    <button
                        ...
                        className="float-left overflow-hidden relative w-1/3 h-14 leading-60 bg-[#434343] rounded-l-md cursor-pointer"
                    >
                        <span className="inline-block w-6 h-5 mt-5 mr-3 mb-0 ml-16 float-left">
                            <img
                                className="w-full"
                                src="/img/ico_cheer.svg"
                                alt="cheerImg"
                            />
                        </span>
                        <span className="inline-block mt-3.5 text-xl text-[#fff] align-baseline float-left mr-1">
                            응원
                        </span>
                        <span className="ml-0 inline-block text-base text-[#d9d9d9] mt-0 mr-16">
                            {support}
                        </span>
                    ...
                    <button
                        ...
                        className="float-left overflow-hidden relative w-2/3 h-14 leading-60 bg-green-600 rounded-r-md cursor-pointer text-center"
                    >
                        <span className="inline-block text-xl text-[#fff] align-baseline">
                            기부하기
                        </span>
                    </button>
                </div>
